    ...
    <div id="row">
		...
		?>
		  ...
		  <div class = "alert alert-info">
			...
			<div class = "alert alert-success" >
			<div class="panel-heading"><center>ASSISTANT SECRETARY</center></div>
			<br />
			<?php
				if(!$_SESSION['ss_id'])
					{
			...
			<div class = "alert alert-success">
			<div class="panel-heading"><center>TECHNICAL DIRECTOR</center></div>
			<br />
			<?php
				if(!$_SESSION['vtr_id'])
					{
			...
			<div class = "alert alert-info">
			<div class="panel-heading"><center>DIRECTOR FOR ACADS</center></div>
			<br />
			<?php
				if(!$_SESSION['tas_id'])
					{
			...
			<div class = "alert alert-success">
			<div class="panel-heading"><center>DIRECTOR FOR NON-ACADS</center></div>
			<br />
			<?php
				if(!$_SESSION['ps_id'])
					{
			...
			<div class = "alert alert-info">
			<div class="panel-heading"><center>COMMITTEE ON LAYOUTS</center></div>
			<br />
			<?php
				if(!$_SESSION['as_id'])
					{
