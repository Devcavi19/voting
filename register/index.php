                         ...
                         <form method = "post" enctype = "multipart/form-data">
                                ...
                                <div class="form-heading">
                         		<center>Voter Registeration</center>
											...
											<div class="form-field">
												<label>Course <i>(enter initials only i.e BSCS,BSBA, BSTM..)</i></label><br/>
													<input class="form-control"  type = "text" name = "prog_study" placeholder="E.e BSCS,BSBA, BSTM" required="true">
											</div>

											<div class="form-field">
												<label>Select Year Level</label> <br/>
