...
<body>
    ...
    if(isset($_SESSION['success_msg'])) {
        echo "<script>alert('System user successfully created');</script>";
                                    ...
                                    <tbody>
										...
										?>
                                            ...
                                            <td style="text-align:center">
												 ...
												 <a rel="tooltip" title="Delete" id="<?php echo $user_id ?>" href="#delete_admin<?php echo $user_id; ?>" data-target="#delete_admin<?php echo $user_id; ?>" data-toggle="modal" class="btn btn-danger btn-outline"><i class="fa fa-trash-o"></i> Delete</a>	
